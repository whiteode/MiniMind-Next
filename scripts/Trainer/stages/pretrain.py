...
STAGE_DEFAULTS = dict(save_weight='pretrain', epochs=1, batch_size=32, learning_rate=5e-4,
...
def run(args):
    ...
    for epoch, loader, iters, st, indices in for_each_epoch(
        ...
        train_epoch_sft(ctx, epoch, loader, iters, st, indices=indices)
