...
def train_epoch(epoch, loader, iters, start_step=0, wandb=None):
    ...
    for step, (input_ids, labels) in enumerate(loader, start=start_step + 1):
        ...
        if (step % args.save_interval == 0 or step == iters - 1) and is_main_process():
            save_checkpoint(lm_config, model, optimizer, args, epoch, step, scaler=scaler, wandb=wandb)
...
if __name__ == "__main__":
    ...
    add_train_args(parser, save_weight='full_sft', epochs=2, batch_size=16,
                   learning_rate=1e-6, max_seq_len=340,
    ...
    for epoch, loader, iters, st, _ in for_each_epoch(
        ...
        train_epoch(epoch, loader, iters, st, wandb)
